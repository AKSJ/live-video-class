...
function serveClientView(request, reply) {
	...
	if (s2m_api) {
		...
		if (s2m_api.membershipLevel === 10 || s2m_api.membershipLevel === 9) {
			...
			console.log('Successful Login! (Client) Name: ' + locals.displayName + 'Email: ' + locals.email);
	...
	if (s2m_api && request.auth.isAuthenticated) {
		...
		if (s2m_api.membershipLevel !== 10 && s2m_api.membershipLevel !== 9) {
			...
			if (s2m_api.membershipLevel === 9) {
				...
				console.log('Successful Login! (Instructor) Name: ' + locals.displayName + 'Email: ' + locals.email);
				...
				console.log('Successful Login! (Admin) Name: ' + locals.displayName + 'Email: ' + locals.email);
